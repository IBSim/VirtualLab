...
Mesh.PipeSegmentN = 16 # Number of segments for pipe circumference
...
Sim.Theta = 0.5
Sim.dt = [(0.01,200,2), (0.05,200,2), (0.1,100,2), (0.5,100,2), (1,50,2), (5,50,2) ] #timestep size and number of steps [(0.01,200,2)]  => 99% temp is reached at [(0.01,200,2), (0.2,1650,5)]
...
Sim.CaptureTime = "all" # or 2.0 for all increments
