...
'''
Aster.SimName = 'Single'
Aster.CommFile = 'Tensile' # The CodeAster command file can be found in Scripts/$SIMULATION/Aster
Aster.Mesh = 'Notch1' # The mesh used in the simulation
Aster.Load = {'Force':1000000, 'Displacement':0.01}
Aster.ResName = ['ConstForce', 'ConstDisp'] # Name of results file(s) which will be output by CodeAster
# Material type(s) for analysis, the properties of which can be found in the 'Materials' directory
Aster.Materials = 'Copper'
