...
VirtualLab.Control(RunMesh=False, RunSim=False, Port=2810)

# Creates meshes
VirtualLab.Mesh(ShowMesh=False, MeshCheck=None)

# Run Pre-Sim calculations, CodeAster and Post-Sim calculations/imaging
VirtualLab.Sim(RunPreAster=True, RunAster=True, RunPostAster=True, ShowRes=True, mpi_nbcpu=1, mpi_nbnoeud=1, ncpus=2, memory=10)
