...
VirtualLab.Control(RunMesh=0, RunSim=1, RunML=0)
...
VirtualLab.devSim(RunPreAster=1, RunAster=0, RunPostAster=1, NumThreads=5, ShowRes=0, mpi_nbcpu=1, mpi_nbnoeud=1, ncpus=2, memory=10)
