...
def Optimise_Field(VL,DADict):
    ...
    if hasattr(Parameters,'TCLocations'):
        ...
        OptDict = {'Confidence':Parameters.InverseDict['Confidence'],
                   'Nbslsqp':Parameters.InverseDict['Nbslsqp']}
        ...
        print('No inverse work considered')
        return
...
def field_inverse(TCData, model, meshfile, InvDict):
    ...
    for SurfName,x1,x2 in TCData:
        ...
        TC_interp.append([nodes,weights]) # Needed to make a prediction using the model
