...
The variables in this file are assigned to different ``Namespaces``; *Mesh*, *Sim* and *DA*. A ``Namespace`` is essentially an empty class which attributes can be assigned to.
...
DA (Data Analysis) is used to analyse the data collected from simulations.
...
.. class:: VLSetup
 ...
 .. attribute:: DA(NumThreads=1)

    This function is the Data analysis branch of **VirtualLab**.
